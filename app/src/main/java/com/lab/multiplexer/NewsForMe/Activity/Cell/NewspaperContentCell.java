...
public class NewspaperContentCell extends SimpleCell<News, NewspaperContentCell.ViewHolder>
    ...
    DatabaseHelper db;
    public NewspaperContentCell(News item) {
        super(item);
    }
    ...
    protected void onBindViewHolder(ViewHolder holder, final int position, final Context context, Object payload) {
        ...
        holder.parent_holder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.putExtra("category", "Newspaper");
                i.putExtra("position",position);
                i.putExtra("language",getItem().getLanguage());
                i.putExtra("from",getItem().getSource().substring(0,1).toUpperCase()+getItem().getSource().substring(1));
