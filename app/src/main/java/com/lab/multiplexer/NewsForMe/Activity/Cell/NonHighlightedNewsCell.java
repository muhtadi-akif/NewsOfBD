...
public class NonHighlightedNewsCell extends SimpleCell<News, NonHighlightedNewsCell.ViewHolder>
    ...
    DatabaseHelper db;
    public NonHighlightedNewsCell(News item) {
        super(item);
    }
        ...
        if(pref.getString("language","").equals("Bangla")){
            ...
            holder.parent_holder.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    i.putExtra("from",getItem().getCategoryName().substring(0,1).toUpperCase()+getItem().getCategoryName().substring(1));
